// =========================================================================
// VIEMAR TOOLFLOW v1.10.3 - GOOGLE FIREBASE CONFIG & SYNC ENGINE
// =========================================================================
...
if (firebaseConfig.apiKey && firebaseConfig.apiKey !== "SUA_API_KEY_AQUI") {
  try {
    if (typeof firebase !== 'undefined') {
      ...
      console.log("[Viemar ToolFlow v1.10.3] Firebase Firestore e Auth ativos. Storage desativado para operar sem plano pago.");
    }
  } catch (err) {
  ...
  window.isFirebaseConnected = false;
  console.log("[Viemar ToolFlow v1.10.3] Operando com persistencia local em cache (Pronto para conectar ao Firebase).");
}
